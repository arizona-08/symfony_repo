...
class User
{
     ...
     */
    #[ORM\OneToMany(targetEntity: SubscriptionHistory::class, mappedBy: 'author', orphanRemoval: true)]
    private Collection $subscriptionHistories;

    /**
     * @var Collection<int, WatchHistory>
     */
    #[ORM\OneToMany(targetEntity: WatchHistory::class, mappedBy: 'author', orphanRemoval: true)]
    ...
    public function removeWatchHistory(WatchHistory $watchHistory): static
    {
        if ($this->watchHistories->removeElement($watchHistory)) {
            // set the owning side to null (unless already changed)
            if ($watchHistory->getAuthor() === $this) {
                $watchHistory->setAuthor(null);
            }
        }
